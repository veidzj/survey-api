...
export class SurveyResultMongoRepository implements SaveSurveyResultRepository, LoadSurveyResultRepository {
  async save (data: SaveSurveyResultRepository.Params): Promise<void> {
    const surveysResultsCollection = MongoHelper.getCollection('surveysResults')
    await surveysResultsCollection.findOneAndUpdate({
  ...
  async loadBySurveyId (surveyId: string, accountId: string): Promise<LoadSurveyResultRepository.Result> {
    ...
    const query = new QueryBuilder()
      ...
      .build()
    const surveyResult = await surveysResultsCollection.aggregate<SurveyResultModel>(query).toArray()
